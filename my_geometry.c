...
bool parse_circle(int *circumflex_counter, char **curs, char **end,
                  unsigned int *record_counter);
bool parse_triangle(int *circumflex_counter, char **curs, char **end,
                    unsigned int *record_counter);
  ...
  for (;;) {
    ...
    if (error == true) {
      ...
      printf("Your figure - circle(%.1f %.1f, %.1f)\n",
             var_circle.x[*record_counter], var_circle.y[*record_counter],
  ...
  for (;;) {
    ...
    if ((error == true) && (x1 == x4) && (y1 == y4)) {
      ...
      printf("Your figure - triangle((%.1f %.1f, %.1f %.1f, %.1f %.1f, "
             ...
             var_triangle.x2[*record_counter], var_triangle.y2[*record_counter],
             var_triangle.x3[*record_counter], var_triangle.y3[*record_counter],
